...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://linkedin.com/${variables.linkedin}" target="_blank"><i class="bi bi-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${variables.instagram}" target="_blank"><i class="bi bi-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
